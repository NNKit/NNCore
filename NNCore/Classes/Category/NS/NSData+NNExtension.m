...
@implementation NSData (NNExtension)
...
#if DEBUG
    if (error) {
        NSLog(@"JSON ValueDecoded error:%@", error);
    }
#endif
    return value;
}
...
@implementation NSData (NNEncodeExtension)
...
@implementation NSData (NNHashExtension)
...
@implementation NSData (NNEncryptExtension)
