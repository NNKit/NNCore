...
//  NNCore
//  more detail on https://github.com/ibireme/YYKit/blob/master/YYKit/Base/Foundation/NSString%2BYYAdd.h
...
@interface NSString (NNValidateExtension)

/** 是否是合法的手机号码格式, 仅验证 1开头+11位数字 */
@property (assign, nonatomic, readonly)   BOOL isPhone;
/** 是否是合法的email邮箱 */
@property (assign, nonatomic, readonly)   BOOL isEmail;
/** 是否是合法的大陆身份证 */
@property (assign, nonatomic, readonly)   BOOL isIdentifyCard;
...
@interface NSString (NNHashExtension)
...
@interface NSString (NNEncodeExtension)
...
@interface NSString (NNDrawExtension)
...
@interface NSString (NNNumberExtension)
